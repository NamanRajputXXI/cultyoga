      ...
      <footer className="bg-gray-900">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-center  font-dynaPuff text-3xl text-white sm:justify-start">
                cultYoga
              </div>

              <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
                Cure our generation by yoga and fitness
              </p>
                  ...
                  <ul className="space-y-4 text-sm">
                    ...
                    <li>
                      <a
                        ...
                        href="/"
                      >
                        yoga guide for particular disease
                      </a>
                    </li>
